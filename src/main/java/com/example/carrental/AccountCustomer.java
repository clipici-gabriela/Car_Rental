...
public class AccountCustomer implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        try {
            ResultSet rs = connectDB.createStatement().executeQuery("SELECT * FROM customers WHERE username = '"+ username +"'");
